...
class TransformSpec extends FlatSpec with Matchers {
  ...
  "transformNumber" should
    "return the number in a set if the number is not zero" in {
  ...
  "transform" should
    "transform the input sudoku puzzle into a puzzle suitable for solving" in {
  ...
  "inverseTransformNumber" should
    "be the inverse function of transformNumber" in {
